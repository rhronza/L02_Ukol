...
public class Main {
	...
	public static void main(String[] args) {
		...
		aktualniPocasi="Aktuální počasí pro město: "+pocasi.getOdpovedAktualniPocasi().getBody().getObject().getString("name")+"\n"+
						...
						"  rychlost větru:         "+pocasi.getOdpovedAktualniPocasi().getBody().getObject().getJSONObject("wind").getDouble("speed")+"\n"+
		...
		predpovedPocasi="\n"+
						"Předpověď počasí na 5 dnů pro město: "+pocasi.getOdpovedPredpovedPocasi().getBody().getObject().getJSONObject("city").getString("name")+"\n"+
						...
						"  rychlost větru:           "+pocasi.getOdpovedPredpovedPocasi().getBody().getObject().getJSONArray("list").getJSONObject(0).getJSONObject("wind").getDouble("speed")+"\n"+
